...
OUT = r"C:\Users\jordi\Documents\GitHub\decodifica.net\public\og\blog\crear-agente-voz-ia-sin-programar.png"
...
# Main title - 2 lines so it fits
title_font = ImageFont.truetype(FONT_BOLD, 86)
line1 = "C\u00f3mo crear un Agente de Voz"
line2 = "con IA sin programar"
...
total_h = sum(s[1] for s in line_sizes) + 20 * (len(lines) - 1)
...
sub = "ElevenLabs, Vapi, Retell y m\u00e1s  -  gratis y en 5 minutos"
